...
void SoftmaxWithLossLayerNegative<Dtype>::LayerSetUp(
...
template <typename Dtype>
void SoftmaxWithLossLayerNegative<Dtype>::Reshape(
    const vector<Blob<Dtype>*>& bottom, vector<Blob<Dtype>*>* top) {
...
template <typename Dtype>
void SoftmaxWithLossLayerNegative<Dtype>::Forward_cpu(
    const vector<Blob<Dtype>*>& bottom, vector<Blob<Dtype>*>* top) {
...
template <typename Dtype>
void SoftmaxWithLossLayerNegative<Dtype>::Backward_cpu(const vector<Blob<Dtype>*>& top,
...
#ifdef CPU_ONLY
STUB_GPU(SoftmaxWithLossLayerNegative);
#endif

INSTANTIATE_CLASS(SoftmaxWithLossLayerNegative);
